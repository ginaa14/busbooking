                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group mb-2">
                                <input class="form-control" type="text" name="key" id="key" placeholder="Cari Nama Sifat..." value="<?= $key ?>">
                            </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <button type="button" class="btn btn-success mb-2 ml-2 btn-block" data-toggle="modal" data-target="#formaddbus"><i class="fa fa-plus"></i> Tambah Sifat</button>
                        </div>
                    </div>
                </div>
            </div> </form>
        ...
        <table class="table table-bordered table-striped">
          ...
          ?>
            <tr>
              ...
              <td style="text-align: center;"><?= $a['sifat']; ?></td>
              <td style="text-align: center;">
                <button class="btn btn-warning btn-sm btn_ubahbus" data-id="<?= $a['id'] ?>"  data-name="<?= $a['sifat'] ?>"><i class="fa fa-edit"></i> Edit</button>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="formModalLabelBus">Add Data Sifat</h5>
      ...
      <div class="modal-body">
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="addname">Nama Sifat</label>
            <input class="form-control" type="text" name="addname" id="addname" placeholder="Nama Sifat">
...
<div class="modal fade" id="formeditbus" tabindex="-1" aria-labelledby="formModalLabelBus">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="formModalLabelBus">Edit Data Sifat</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        </button>
      </div>
      <div class="modal-body">
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="editname" id="editname" placeholder="Nama Sifat">
...
<div class="modal fade" id="formdeletebus" tabindex="-1" aria-labelledby="formModalLabebus">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="formModalLabebus">Anda ingin menghapus data sifat ini?</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        </button>
      </div>
