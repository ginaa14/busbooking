                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group mb-2">
                                <input class="form-control" type="text" name="key" id="key" placeholder="Cari Nama Manager..." value="<?= $key ?>">
                            </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <button type="button" class="btn btn-success mb-2 ml-2 btn-block" data-toggle="modal" data-target="#formaddmanager"><i class="fa fa-plus"></i> Tambah Manager</button>
                        </div>
                    </div>
                </div>
            </div> </form>
...
<div class="modal fade" id="formdeletemanager" tabindex="-1" aria-labelledby="formModalLabeManager">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="formModalLabeManager">Anda ingin menghapus data manager ini?</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        </button>
      </div>
